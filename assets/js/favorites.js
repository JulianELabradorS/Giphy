		...
		if (i < favoritesLimit) {
			let template = `<div class="favorites__results__gifs__gif">
                ...
                <div class="favorites__results__gifs__gif__hover">
					<img src="./assets/images/gifIcons/icon-trash-hover.svg" alt="boton quitar favorito" onclick="removeFavorite('${id}')" class="fav__icon" />
                    <img
                        src="./assets/images/gifIcons/icon-download-hover.svg"
                        alt="boton descargar gif"
						class="download__icon"
						onclick="downloadGif('${image}','${title}')"
					/>
                    <img src="./assets/images/gifIcons/icon-max-hover.svg" alt="boton agrandar gif" onclick="searchGif('${id}')" class="max__icon" />
                </div>
            </div>`;
